...
def salary_predictions():
    ...
    return pd.Series(clf.predict_proba(test_data[[0,1,2]].values)[:,1], index=test_data.index)
...
def new_connections_predictions():
    ...
    return pd.Series(clf.predict_proba(test_data[['pref_attachment','comm_neighbors']].values)[:,1], index=test_data.index)
